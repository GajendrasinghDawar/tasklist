  ...
  return (
    <Dropdown>
      ...
      <Dropdown.DropdownMenu>
        ...
        <Dropdown.MenuItem>
          <button className="rounded-md  focus:ring-2 focus:ring-sand6 flex w-full justify-between items-center text-center  bg-sand3 hover:bg-sand4 my-2 h-11 gap-3 px-2 text-sand11 hover:text-sand12">
            log out
            <ExitIcon />
          </button>
        </Dropdown.MenuItem>
